                ...
                <div class="p-6 lg:p-8 bg-white border-b border-gray-200">
                    ...
                    <div id="alert-4" class="flex items-center p-4 mb-4 text-yellow-800 rounded-lg bg-yellow-50" role="alert">
                        ...
                        <div class="ml-3 text-sm font-medium">
                            Baza danych jest pusta, <a href="{{route('second.flat.create')}}" class="font-semibold underline hover:no-underline">utwórz dane</a> aby zapewnić prawidłowe działanie.
                        </div>
                    ...
                    <div class="flex flex-row justify-between align-center items-center">
                        ...
                        <a href="{{route('second.flat.create')}}" class="inline-flex items-center justify-center w-10 h-10 mr-2 text-green-100 transition-colors duration-150 bg-green-500 rounded-full focus:shadow-outline hover:bg-green-600">
                        ...
                        <table class="w-full text-sm text-left text-gray-500">
                            ...
                            <tbody class="text-center">
                                ...
                                <tr>
                                    ...
                                    <td class="px-4 py-2">
                                        <a href="{{ route('invest.show.second', $table->id) }}" class="px-5 py-2.5 text-center mx-1 my-1 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-600 focus:z-10 focus:ring-4 focus:ring-gray-200"><i class="fa-solid fa-eye"></i></a>
                                    </td>
                                    <td class="px-4 py-2">
                                        <a href="{{ route('second.flat.edit', $table->id) }}" class="text-white bg-indigo-500 hover:bg-indigo-600 focus:ring-4 focus:ring-indigo-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mx-1 my-1 focus:outline-none">
                                            <i class="fa-solid fa-pen-to-square"></i>
                                        </a>
                                    </td>
                                    <td class="px-4 py-2">
                                        <form action="{{ route('second.flat.delete', $table->id) }}" method="POST" onsubmit="return confirm('Czy na pewno chcesz to usunąć?')">
                                            @csrf
                                            @method('DELETE')
