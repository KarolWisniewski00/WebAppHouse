            ...
            <div class="col-12">
                <div class="d-flex flex-column justify-content-center align-items-center mb-3" style="overflow:hidden">
                    ...
                    <div class="position-relative">
                        ...
                        @if($t->id == 1)
                        <div class="s-neutral-b position-absolute p-1px @if($t->status == 'avaiable') {{'segment-success'}} @elseif ( $t->status == 'reservation' ) {{'segment-warning'}} @else {{'segment-danger'}} @endif" style="top: 39%;left: 33%;width: 10.5%;height: 24%;">
                        ...
                        @elseif($t->id == 2)
                        <div class="s-neutral-b position-absolute p-1px @if($t->status == 'avaiable') {{'segment-success'}} @elseif ( $t->status == 'reservation' ) {{'segment-warning'}} @else {{'segment-danger'}} @endif" style="top: 39%;left: 25%;width: 8%;height: 24%;">
                            <div class="h-100 w-100">
                                <div class="d-flex flex-row justify-content-center align-items-center text-center h-100 btn-d">
                        ...
                        @elseif($t->id == 3)
                        <div class="s-neutral-b position-absolute p-1px @if($t->status == 'avaiable') {{'segment-success'}} @elseif ( $t->status == 'reservation' ) {{'segment-warning'}} @else {{'segment-danger'}} @endif" style="top: 39%;left: 14%;width: 11%;height: 24%;">
                            <div class="h-100 w-100">
                                <div class="d-flex flex-row justify-content-center align-items-center text-center h-100 btn-d">
                        ...
                        @elseif($t->id == 4)
                        <div class="s-neutral-b position-absolute p-1px @if($t->status == 'avaiable') {{'segment-success'}} @elseif ( $t->status == 'reservation' ) {{'segment-warning'}} @else {{'segment-danger'}} @endif" style="top: 11%;left: 14%;width: 11%;height: 24%;">
                            <div class="h-100 w-100">
                                <div class="d-flex flex-row justify-content-center align-items-center text-center h-100 btn-d">
                        ...
                        @elseif($t->id == 5)
                        <div class="s-neutral-b position-absolute p-1px @if($t->status == 'avaiable') {{'segment-success'}} @elseif ( $t->status == 'reservation' ) {{'segment-warning'}} @else {{'segment-danger'}} @endif" style="top: 11%;left: 25%;width: 8%;height: 24%;">
                            <div class="h-100 w-100">
                                <div class="d-flex flex-row justify-content-center align-items-center text-center h-100 btn-d">
                        ...
                        @elseif($t->id == 6)
                        <div class="s-neutral-b position-absolute p-1px @if($t->status == 'avaiable') {{'segment-success'}} @elseif ( $t->status == 'reservation' ) {{'segment-warning'}} @else {{'segment-danger'}} @endif" style="top: 14%;left: 33%;width: 10.5%;height: 21%;">
                            <div class="h-100 w-100">
                                <div class="d-flex flex-row justify-content-center align-items-center text-center h-100 btn-d">
                        ...
                        @elseif($t->id == 7)
                        <div class="s-neutral-b position-absolute p-1px @if($t->status == 'avaiable') {{'segment-success'}} @elseif ( $t->status == 'reservation' ) {{'segment-warning'}} @else {{'segment-danger'}} @endif" style="top: 14%;left: 43.5%;width: 11%;height: 21%;">
                            <div class="h-100 w-100">
                                <div class="d-flex flex-row justify-content-center align-items-center text-center h-100 btn-d">
                        ...
                        @elseif($t->id == 8)
                        <div class="s-neutral-b position-absolute p-1px @if($t->status == 'avaiable') {{'segment-success'}} @elseif ( $t->status == 'reservation' ) {{'segment-warning'}} @else {{'segment-danger'}} @endif" style="top: 11%;left: 54.5%;width: 11.5%;height: 24%;">
                            <div class="h-100 w-100">
                                <div class="d-flex flex-row justify-content-center align-items-center text-center h-100 btn-d">
                        ...
                        @elseif($t->id == 9)
                        <div class="s-neutral-b position-absolute p-1px @if($t->status == 'avaiable') {{'segment-success'}} @elseif ( $t->status == 'reservation' ) {{'segment-warning'}} @else {{'segment-danger'}} @endif" style="top: 11%;left: 66%;width: 11.5%;height: 36%;">
                            <div class="h-100 w-100">
                                <div class="d-flex flex-row justify-content-center align-items-center text-center h-100 btn-d">
                        ...
                        @elseif($t->id == 10)
                        <div class="s-neutral-b position-absolute p-1px @if($t->status == 'avaiable') {{'segment-success'}} @elseif ( $t->status == 'reservation' ) {{'segment-warning'}} @else {{'segment-danger'}} @endif" style="top: 58%;left: 54.5%;width: 11.5%;height: 24%;">
                            <div class="h-100 w-100">
                                <div class="d-flex flex-row justify-content-center align-items-center text-center h-100 btn-d">
                        ...
                        @elseif($t->id == 11)
                        <div class="s-neutral-b position-absolute p-1px @if($t->status == 'avaiable') {{'segment-success'}} @elseif ( $t->status == 'reservation' ) {{'segment-warning'}} @else {{'segment-danger'}} @endif" style="top: 46%;left: 66%;width: 11.5%;height: 36%;">
                            <div class="h-100 w-100">
                                <div class="d-flex flex-row justify-content-center align-items-center text-center h-100 btn-d">
                    ...
                    <div class="position-relative">
                        ...
                        @foreach($tables as $key => $t)
                        @if($t->id == 24)
                        <div class="s-neutral-b position-absolute p-1px @if($t->status == 'avaiable') {{'segment-success'}} @elseif ( $t->status == 'reservation' ) {{'segment-warning'}} @else {{'segment-danger'}} @endif" style="top: 39%;left: 43.5%;width: 11%;height: 20%;">
                            <div class="h-100 w-100">
                                <div class="d-flex flex-row justify-content-center align-items-center text-center h-100 btn-d">
