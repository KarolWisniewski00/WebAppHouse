                ...
                <div class="row text-start">
                    <div class="col-6 gsap">
                        <div class="d-flex flex-column justify-content-center align-items-center text-center my-1">
                            <a href="" class="btn btn-extra mb-4 fs-2" type="button" style="background-color: #0f4c64;">{!! $setting['ikona_1_sekcji_2_na_stronie_glownej'] !!}</a>
                    ...
                    <div class="col-6 gsap">
                        <div class="d-flex flex-column justify-content-center align-items-center text-center my-1">
                            <a href="" class="btn btn-extra mb-4 fs-2" type="button" style="background-color: #0f4c64;">{!! $setting['ikona_2_sekcji_2_na_stronie_glownej'] !!}</a>
