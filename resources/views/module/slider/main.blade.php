    ...
    <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <img alt="" src="{{asset('asset/photo/'.$setting['zdjecie_1_karuzela_1_na_stronie_glownej'])}}" class="filter w-100 h-100">
                <div class="container">
            ...
            <div class="carousel-item">
                ...
                <img alt="" src="{{asset('asset/photo/'.$setting['zdjecie_2_karuzela_1_na_stronie_glownej'])}}" class="filter w-100 h-100">
                <div class="container">
                    <div class="carousel-caption text-end fpb">
            ...
            <div class="carousel-item">
                ...
                <img alt="" src="{{asset('asset/photo/'.$setting['zdjecie_3_karuzela_1_na_stronie_glownej'])}}" class="filter w-100 h-100">
                <div class="container">
                    <div class="carousel-caption text-end fpb">
            ...
            <div class="carousel-item">
                ...
                <img alt="" src="{{asset('asset/photo/'.$setting['zdjecie_4_karuzela_1_na_stronie_glownej'])}}" class="filter w-100 h-100">
                <div class="container">
                    <div class="carousel-caption text-end fpb">
            ...
            <div class="carousel-item">
                ...
                <img alt="" src="{{asset('asset/photo/'.$setting['zdjecie_5_karuzela_1_na_stronie_glownej'])}}" class="filter w-100 h-100">
                <div class="container">
                    <div class="carousel-caption text-end fpb">
            ...
            <div class="carousel-item">
                ...
                <img alt="" src="{{asset('asset/photo/'.$setting['zdjecie_6_karuzela_1_na_stronie_glownej'])}}" class="filter w-100 h-100">
                <div class="container">
                    <div class="carousel-caption text-end fpb">
